...
## Project Structure
    ...
    ├── testapiautosettings_98456  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_98456`
...
2. Clone this repo and `cd testapiautosettings_98456`
